...
function ProjectCard({
  ...
  return (
    <div id={`${index}project`} className="mx-auto">
      {/* tilting for bigger screens */}
      <Tilt
        className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full hidden mdms:block"
      ...
      {/* no tilting for smaller screens */}
      <div className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full mdms:hidden">
        <article title={`Uzelac Light ${name}`}>
          <div className="relative w-full h-[230px]">
            {/* image of project */}
            <img
